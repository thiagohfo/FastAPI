...
app = FastAPI()
app.include_router(reservations.router, prefix="/student")
app.include_router(admin.router, prefix="/student")
app.include_router(assignments.router, prefix="/student")
