...
@app.get("/account/profile/view/{username}")
...
@app.post("/discussion/posts/reply/{username}")
...
@app.put("/discussion/posts/update/{username}")
...
@app.get("/discussion/posts/view/{username}")
...
@app.post("/login/rememberme/create/")
